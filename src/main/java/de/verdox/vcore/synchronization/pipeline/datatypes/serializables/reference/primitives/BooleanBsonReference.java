 ...
 */
public class BooleanBsonReference extends VCoreFieldReference<Boolean> {
    public BooleanBsonReference(@NotNull Map<String, Object> data, @NotNull String fieldName) {
