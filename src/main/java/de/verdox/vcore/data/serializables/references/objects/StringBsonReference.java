...
package de.verdox.vcore.data.serializables.references.objects;
...
public class StringBsonReference extends VCoreBsonReference<String> {
    public StringBsonReference(@Nonnull VCoreSerializable vCoreSerializable, @Nonnull String fieldName) {
