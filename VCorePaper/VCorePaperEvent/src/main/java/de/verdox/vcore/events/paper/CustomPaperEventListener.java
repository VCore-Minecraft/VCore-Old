...
package de.verdox.vcore.events.paper;

import de.verdox.vcore.events.paper.blockevents.chestevents.ChestMergeEvent;
import de.verdox.vcore.events.paper.blockevents.chestevents.ChestSplitEvent;
import de.verdox.vcore.events.paper.playerevents.PlayerMilkCowEvent;
import de.verdox.vcore.events.paper.playerevents.PlayerPreOpenContainerEvent;
...
import de.verdox.vcorepaper.utils.BukkitServerUtil;
import de.verdox.vcorepaper.utils.BukkitWorldUtil;
 ...
 */
public class CustomPaperEventListener extends VCorePaperListener {
    public CustomPaperEventListener(VCorePaperPlugin plugin) {
        super(plugin);
    }
