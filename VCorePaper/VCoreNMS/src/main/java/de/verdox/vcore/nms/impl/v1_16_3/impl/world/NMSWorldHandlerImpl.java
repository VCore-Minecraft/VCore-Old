...
package de.verdox.vcore.nms.impl.v1_16_3.impl.world;
...
import de.verdox.vcore.nms.impl.v1_16_3.wrapper.ChunkPacketWrapperImpl;
import de.verdox.vcore.nms.impl.v1_16_3.wrapper.WorldBorderPacketWrapperImpl;
...
public class NMSWorldHandlerImpl implements NMSWorldHandler {
    ...
    public void sendFakeBiome(@NotNull Player player, @NotNull Chunk chunk, @NotNull Biome biome, Runnable callback) {
        ChunkPacketWrapperImpl chunkPacketWrapper = new ChunkPacketWrapperImpl(chunk, 65535, true);
        int[] biomeArray = chunkPacketWrapper.biomes.readField();
        Arrays.fill(biomeArray, VanillaUtil.getBiomeID_1_16(biome));
    ...
    public void sendFakeWorldBorder(@NotNull Player player, @NotNull Location center, @NonNegative double size, Runnable callback) {
        WorldBorderPacketWrapperImpl worldBorderPacketWrapper = new WorldBorderPacketWrapperImpl();
        plugin
                .createTaskBatch()
                .doAsync(() -> {
                    CraftPlayer craftPlayer = (CraftPlayer) player;
