...
package de.verdox.vcore.nms.api.packetabstraction;
...
public abstract class PacketListener {
    ...
    public PacketListener(VCorePaperPlugin plugin, ProtocolManager protocolManager, ListenerPriority listenerPriority, boolean applyGlobal, PacketType... packetTypes) {
        this.plugin = plugin;
        this.protocolManager = protocolManager;
        this.applyGlobal = applyGlobal;


        PacketAdapter adapter = new PacketAdapter(plugin, listenerPriority, packetTypes) {
            @Override
