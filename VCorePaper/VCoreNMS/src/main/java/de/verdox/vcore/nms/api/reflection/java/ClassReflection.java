...
public class ClassReflection {
    ...
    public static class ReferenceClass {
        ...
        public Object instantiate(Object... paramTypes) {
            Class<?>[] classArray = (Class<?>[]) Arrays.stream(paramTypes).map(Object::getClass).toArray();
            return ConstructorReflection.findConstructor(reflectedClass, classArray).instantiate(paramTypes);
        }
