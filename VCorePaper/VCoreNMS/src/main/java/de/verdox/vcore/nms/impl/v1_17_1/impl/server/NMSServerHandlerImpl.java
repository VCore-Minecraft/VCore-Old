...
package de.verdox.vcore.nms.impl.v1_17_1.impl.server;
...
public class NMSServerHandlerImpl implements NMSServerHandler {
    ...
    @Override
    public Command registerRuntimeCommand(@NotNull VCorePaperPlugin plugin, @NotNull String runtimeCommandIdentifier, @NotNull Consumer<Player> callback) {
        return null;
    }
