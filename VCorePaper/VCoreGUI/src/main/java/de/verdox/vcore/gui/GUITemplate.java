...
public class GUITemplate {
    ...
    public static AnvilGUI.Builder createStringInput(VCorePaperPlugin plugin, Player player, String title, Function<String, AnvilGUI.Response> callback) {
    ...
    public static AnvilGUI.Builder createIntegerInputGUI(VCorePaperPlugin plugin, Player player, String title, String notValidNumber, Function<Integer, AnvilGUI.Response> callback) {
        return new AnvilGUI.Builder()
                .plugin(plugin)
                .title(ChatColor.translateAlternateColorCodes('&', title))
                .itemLeft(new ItemStack(Material.GOLD_INGOT))
    ...
    public static AnvilGUI.Builder createDoubleInputGUI(Locale parsingLocale, VCorePaperPlugin plugin, Player player, String title, String notValidNumber, Function<Double, AnvilGUI.Response> callback) {
        return new AnvilGUI.Builder()
                .plugin(plugin)
                .title(ChatColor.translateAlternateColorCodes('&', title))
                .itemLeft(new ItemStack(Material.GOLD_INGOT))
    ...
    public static void createSelectConfirmationGUI(VCorePaperPlugin plugin, Player player, Function<Boolean, VCoreGUI.Response<?, ?>> callback) {
        VCoreItem yesItem = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().createItemBuilder(Material.GREEN_STAINED_GLASS_PANE, 1, "&aYes").buildItem();
        VCoreItem noItem = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().createItemBuilder(Material.RED_STAINED_GLASS_PANE, 1, "&cNo").buildItem();
        createSelectConfirmationGUI(plugin, player, "&eAre you sure?", yesItem, noItem, callback);
    }

    public static void createSelectConfirmationGUI(VCorePaperPlugin plugin, Player player, String title, String yesTitle, String noTitle, Function<Boolean, VCoreGUI.Response<?, ?>> callback) {
        VCoreItem yesItem = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().createItemBuilder(Material.GREEN_STAINED_GLASS_PANE, 1, yesTitle).buildItem();
        VCoreItem noItem = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().createItemBuilder(Material.RED_STAINED_GLASS_PANE, 1, noTitle).buildItem();
        createSelectConfirmationGUI(plugin, player, title, yesItem, noItem, callback);
    }

    public static void createSelectConfirmationGUI(VCorePaperPlugin plugin, Player player, String title, VCoreItem yesItem, VCoreItem noItem, Function<Boolean, VCoreGUI.Response<?, ?>> callback) {
        CustomItemManager customItemManager = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager();
    ...
    public static void selectMaterial(VCorePaperPlugin plugin, Player player, Function<VCoreGUI.VCoreGUIClick<Material>, VCoreGUI.Response<?, ?>> onClick, Runnable backCallback) {
    ...
    public static class SelectionGUI<T> {
        ...
        public SelectionGUI(@NotNull String title, @NotNull Collection<T> objectList, @NotNull VCorePaperPlugin plugin, @Positive int page, @Positive int rows, @NotNull Function<T, ItemStack> objectToItemStack) {
            this.title = title;
        ...
        public SelectionGUI(@NotNull String title, @NotNull Supplier<Collection<T>> listSupplier, @NotNull VCorePaperPlugin plugin, @Positive int page, @Positive int rows, @NotNull Function<T, ItemStack> objectToItemStack) {
            this.title = title;
        ...
        public SelectionGUI(@NotNull String title, @NotNull Collection<T> objectList, @NotNull VCorePaperPlugin plugin, @NotNull Function<T, ItemStack> objectToItemStack) {
            this(title, objectList, plugin, 1, 4, objectToItemStack);
        }

        public SelectionGUI(@NotNull String title, @NotNull Supplier<Collection<T>> listSupplier, @NotNull VCorePaperPlugin plugin, @NotNull Function<T, ItemStack> objectToItemStack) {
            this(title, listSupplier, plugin, 1, 4, objectToItemStack);
        }

        public SelectionGUI(@NotNull String title, @NotNull Collection<T> objectList, @NotNull VCorePaperPlugin plugin, @Positive int rows, @NotNull Function<T, ItemStack> objectToItemStack) {
            this(title, objectList, plugin, 1, rows, objectToItemStack);
        }

        public SelectionGUI(@NotNull String title, @NotNull Supplier<Collection<T>> listSupplier, @NotNull VCorePaperPlugin plugin, @Positive int rows, @NotNull Function<T, ItemStack> objectToItemStack) {
        ...
        public VCoreGUI.Builder<T> createBuilder() {
            if (builder != null)
                return builder;
            VCoreItem border = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().createItemBuilder(Material.BLACK_STAINED_GLASS_PANE, 1, "&8").buildItem();
            VCoreItem nextPage = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().createItemBuilder(Material.PAPER, 1, "&aNext page").buildItem();
            VCoreItem search = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().createItemBuilder(Material.WRITTEN_BOOK, 1, "&eSearch").buildItem();
            VCoreItem lastPage = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().createItemBuilder(Material.PAPER, 1, "&cLast page").buildItem();
            VCoreItem back = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().createItemBuilder(Material.BARRIER, 1, "&cBack").buildItem();
                    ...
                    .content(contentBuilder -> {
                        ...
                        filterWithPattern()
                                ...
                                .forEach(t -> {
                                    ...
                                    VCoreItem vCoreItem = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().wrap(VCoreItem.class, stack);
