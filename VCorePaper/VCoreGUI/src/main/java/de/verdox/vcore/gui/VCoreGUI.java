...
import de.verdox.vcore.gui.event.PlayerOpenVCoreGUIEvent;
...
public class VCoreGUI<T> implements CustomGUI {
    ...
    public VCoreGUI(VCorePaperPlugin plugin
            , Player player
    ...
    private void closeInventory() {
        if (open) {
            ...
            if (this.completeFunction != null)
                this.completeFunction.apply(player, Arrays.stream(inventory.getContents()).map(stack -> VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().wrap(VCoreItem.class, stack)).collect(Collectors.toList()));
    ...
    public VCorePaperPlugin getPlugin() {
        return plugin;
    }
    ...
    public static class Builder<T> {
        ...
        public Builder<T> plugin(VCorePaperPlugin plugin) {
    ...
    public static class ContentBuilder<T> {
        ...
        public ContentBuilder<T> createBorder(int guiSize) {
            return createBorder(guiSize, VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().getGuiBorderItem(), null);
        }
    ...
    private class VCoreGUIListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if (e.getCurrentItem() == null || e.getCurrentItem().equals(Material.AIR))
                return;
            VCoreItem clickedItem = VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().wrap(VCoreItem.class, e.getCurrentItem());
            ...
            if (response.code.equals(Response.CLOSE))
                ...
                new AnvilGUI.Builder()
                        ...
                        .itemLeft(VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().getItemPreset().blackGUIBorder().getDataHolder())
                ...
                new AnvilGUI.Builder()
                        ...
                        .itemLeft(VCorePaper.getInstance().getModuleLoader().getModule(VCoreNBTModule.class).getCustomItemManager().getItemPreset().redBackButton().getDataHolder())
                        .onLeftInputClick(player -> copy())
