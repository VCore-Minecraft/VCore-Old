package de.verdox.vcorepaper.impl.io;
...
public abstract class VCorePaperConfig extends VCoreConfig<FileConfiguration> {
    public VCorePaperConfig(VCorePaperPlugin plugin, File file) {
        super(plugin, file);
    }

    public VCorePaperConfig(VCorePaperPlugin plugin, String fileName, String pluginDirectory) {
