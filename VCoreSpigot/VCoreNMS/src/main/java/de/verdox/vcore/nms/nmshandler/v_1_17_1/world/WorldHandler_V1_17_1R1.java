...
package de.verdox.vcore.nms.nmshandler.v_1_17_1.world;
 ...
 */
public class WorldHandler_V1_17_1R1 implements NMSWorldHandler {
    @Override
    ...
    public void sendFakeBiome(@NotNull Player player, @NotNull Chunk chunk, @NotNull Biome biome, Runnable callback) {
        ...
        try {
            ...
            Arrays.fill(biomeArray, VCoreUtil.BukkitUtil.getVanillaUtil().getBiomeID_1_17(biome));
